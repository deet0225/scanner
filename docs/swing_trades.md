...
## Liquidity
3. Avg Traded Value 20D > ₹3 Cr
4. Volume Z-score (3-day avg) > 0.7
5. Relative Volume Percentile (60-session) > 50
...
10. Weekly RSI-14 > 57
11. Stock 20D return − Index 20D return > +4%
12. Stock 20D return > Sector avg 20D return + 3%

---

## Entry / Price Structure
13. Closing range ≥ 65%  →  (Close − Low) / (High − Low) ≥ 0.65
14. Close ≤ EMA-20 + 2.0 × ATR-14  (not overextended)
15. Gap-up from previous close ≤ 4%
...
## Stop Loss
- max(3-day structural low,  Entry − 1.5 × ATR-14)
