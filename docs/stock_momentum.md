...
| 2 | Volume Z-score (3-day avg) | ≥ 0.8 | Above-average accumulation occurring |
...
| 4 | Daily RSI-14 | ≥ 60 | Daily momentum zone (early, not peak) |
| 4b | RSI SMA-3 **rising** | must be > prev bar | Momentum accelerating, not stalling |
| 5 | ADX-14 | ≥ 22 | Directional trend establishing |
...
|--------|--------|-------|--------|
| RSI-14 | ≥ 62 | ≥ 60 + SMA-3 rising | Earlier entry, only when accelerating |
| Weekly RSI | ≥ 60 | ≥ 55 + rising | Earlier entry, only upward weekly trend |
| ADX | ≥ 25 | ≥ 22 + rising | Catches trend early before it's established |
| Volume Z | ≥ 0.8 | ≥ 0.8 (unchanged) | No change — threshold remained stable |
